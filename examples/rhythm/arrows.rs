...
impl FromWorld for ArrowMaterialResource {
    fn from_world(world: &mut World) -> Self {
        ...
        let red_handle = asset_server.load("rhythm/images/arrow_red.png");
        let blue_handle = asset_server.load("rhythm/images/arrow_blue.png");
        let green_handle = asset_server.load("rhythm/images/arrow_green.png");
        let border_handle = asset_server.load("rhythm/images/arrow_border.png");
