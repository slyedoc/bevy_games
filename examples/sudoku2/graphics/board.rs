...
mod config {
    ...
    // Fonts
    pub const FIXED_NUM_FONT: &str = "fonts/Ubuntu/Ubuntu-Bold.ttf";
    pub const FILLABLE_NUM_FONT: &str = "fonts/Ubuntu/Ubuntu-Light.ttf";
...
mod actions {
    ...
    pub fn style_numbers(
        cell_query: Query<(&Fixed, &DisplayedBy), Changed<Fixed>>,
